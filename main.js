document.addEventListener('DOMContentLoaded', () => {
    ...
    const allAnnouncements = [
        { title: "Período de Avaliações (1ª Unidade)", content: "Prezados alunos, o período de avaliações da 1ª Unidade terá início na próxima segunda-feira. Consultem o cronograma completo fixado nos murais." },
        { title: "Mudança no Horário da Turma T-QUIM-M3", content: "Atenção, Turma T-QUIM-M3! A disciplina de Química Orgânica foi realocada para a Sala 10. A mudança é válida a partir desta quarta-feira." },
        { title: "Sábado Letivo Obrigatório", content: "Lembramos que o próximo sábado será um Sábado Letivo Obrigatório para todas as turmas, para reposição de feriados. As aulas seguirão a grade da 5ª Feira." }
    ];
...
if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        navigator.serviceWorker.register('/painel-digital-cetep/sw.js')
            .then(registration => {
